...
export default function ForgotPasswordPage({ userType, redirectPath, loginPath }: ForgotPasswordPageProps) {
  const getTitle = () => {
    switch (userType) {
      case 'teacher':
        return '導師忘記密碼';
  ...
  return (
    <div className="nc-PageLogin">
      <div className="container mb-24 lg:mb-32">
        ...
        <ForgotPasswordForm userType={userType} redirectPath={redirectPath} />
